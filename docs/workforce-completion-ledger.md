...
- Visual acceptance caught unreadable inherited finance-header text on a dark background. A shared light-header/CTA-spacing correction is being released and must be checked on the preview and existing finance desks before claiming visual acceptance.
