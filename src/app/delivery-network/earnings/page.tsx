...
function sourceLabel(value: string) {
  return ({ rate_card: "Rate card", mapped_rate: "Mapped rate", imported_payout: "Imported payout", adjustment: "Adjustment", unresolved: "Unresolved",training_attendance:"Biometric attendance" } as Record<string, string>)[value] ?? value;
}
