...
export default async function PayrollPage({ searchParams }: { searchParams?: { from?: string; to?: string; notice?: string; error?: string } }) {
  ...
  return <AppShell active="Payroll Runs" pageCode="workforce_payroll">
    ...
    <p><PendingLink href="/delivery-network/payroll-calendars">Configure station payroll calendars →</PendingLink> · <PendingLink href="/delivery-network/payment-ledger">Associate payment history →</PendingLink></p>
