...
import { capacityMapEmbedUrl, loadCapacityRegionMaps, loadCapacityRules, loadShipmentSizeRule } from "@/lib/ops-pulse/capacity";
...
export default async function CapacityStationPage({ params, searchParams }: { params: { station: string }; searchParams?: SearchParams }) {
  ...
  const [stationDailyResult, associateResult, pincodeResult, ruleResult, sizeResult, requestResult, reviewResult, stationMapResult, rateCardResult, capacityMapResult] = await Promise.all([
