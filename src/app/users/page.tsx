  ...
  return (
    <AppShell active={activeLabel}>
      ...
      <section className="panel">
        ...
        <div className="panel-head"><div><h3>Location Account</h3><p className="subtle">Dashboard grants Workforce to station mailboxes. Configure only which Workforce menus those mailboxes can use.</p></div></div>
        ...
        <div className="panel-head" style={{ borderTop: "1px solid var(--border)" }}><div><h3>People designations</h3><p className="subtle">Only designations enabled for Workforce are listed below.</p></div></div>
