...
export function AppShellFrame({ children, desktopActions, mobileActions, sidebar, variant = "default" }: AppShellFrameProps) {
  ...
  return (
    <div className={`shell ${variant === "workforce" ? "workforce-shell" : ""} ${sidebarOpen ? "sidebar-open" : ""}`.trim()}>
      <EventLogTracker />
