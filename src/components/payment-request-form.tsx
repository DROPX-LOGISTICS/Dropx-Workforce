...
export function PaymentRequestForm({
  ...
  async function verifyBankAccount() {
    ...
    if (savedContact) {
      ...
      setBankVerificationMessage("Verified account found in Contacts. No API call required.");
      return;
    }
  ...
  async function verifyUpiId() {
    ...
    if (savedContact) {
      ...
      setContactEmail(savedContact.email ?? contactEmail);
      setUpiVerified(true);
      setBankVerificationMessage("Verified UPI ID found in Contacts. No API call required.");
      return;
    }
