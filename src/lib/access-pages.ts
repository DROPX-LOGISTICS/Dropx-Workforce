...
export const accessPages = [
  ...
  { code: "assets", name: "Asset Management", sort_order: 56 },
  ...
  { code: "workforce_communications", name: "Workforce Connect Centre", sort_order: 112 },
  ...
  { code: "workforce_speak_up", name: "Workforce Speak Up", sort_order: 116 },
  { code: "workforce_activity", name: "Attendance & Activity", sort_order: 190 },
  { code: "workforce_rate_cards", name: "Workforce Rate Cards", sort_order: 191 },
  { code: "workforce_earnings", name: "Live Workforce Earnings", sort_order: 192 },
  { code: "workforce_incentives", name: "Workforce Incentives", sort_order: 193 },
  { code: "workforce_adjustments", name: "Workforce Adjustments", sort_order: 194 },
  { code: "workforce_payroll", name: "Workforce Payroll", sort_order: 195 },
  ...
  { code: "workforce_categories", name: "Registration Policies", sort_order: 126 },
  ...
  { code: "master_asset_types", name: "Asset Categories & Types", sort_order: 133 },
