...
const groupedParentPermissions: Record<string, string[]> = {
  ...
  ops_pulse: ["daily_submission", "cod_submission", "cod_validation", "cod_reports", "cod_portal_checks"],
  ...
  app_settings: ["app_settings", "ai_connector"],
...
async function ensureMissingCurrentAccessPages(companyId: string) {
  const requiredCodes = ["payments", "expense_requests", "payment_requests", "payment_approvals", "payment_process", "payment_reports", "master_payment_banks", "master_payment_heads", "payment_settings", "imports", "ops_pulse", "daily_submission", "cod_submission", "cod_validation", "cod_reports", "cod_portal_checks", "cod_master", "biometric_devices", "reports", "attendance_reports", "ai_connector", "cps", "cps_overview", "cps_daily", "cps_monthly", "cps_cost_breakup", "cps_stations", "cps_shipments", "cps_associates", "cps_reports", "cps_inputs", "cps_unmapped"];
