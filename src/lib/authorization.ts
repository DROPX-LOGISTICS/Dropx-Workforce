...
const groupedParentPermissions: Record<string, string[]> = {
  ...
  master_data: ["master_locations", "master_providers", "master_models", "payment_methods", "master_payment_banks", "master_payment_heads", "master_contacts", "workforce_categories", "workforce_whatsapp", "designations", "biometric_devices", "cod_master", "master_documents", "master_imports", "master_asset_types"],
  ...
  workforce_communications: ["workforce_communications_app", "workforce_communications_whatsapp", "workforce_communications_history"]
};
