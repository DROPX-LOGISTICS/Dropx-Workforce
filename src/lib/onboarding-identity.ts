...
export function assertOnboardingIdentityAllowed(
  evaluation: OnboardingIdentityEvaluation,
  options: { allowDifferentWorkforceDesignation: boolean }
) {
...
export async function evaluateOnboardingIdentity({
  client,
  companyId,
  mobile,
  designationId,
